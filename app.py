...
# ================= FILES =================
DATA_FILE = "toeic_600_business_vn_detail.json"
...
if menu == "📘 Học theo chủ đề":
    ...
    st.markdown("### 🇻🇳 Nghĩa tiếng Việt (chuẩn môi trường doanh nghiệp)")
...
if menu == "📈 Dashboard":
    ...
    st.write("Nên học 10–15 từ mỗi ngày để ghi nhớ lâu và cải thiện điểm TOEIC hiệu quả.")
