...
# ================= FILES =================
DATA_FILE = "toeic_600_business_vn.json"
...
if menu == "📘 Học theo chủ đề":
    ...
    st.markdown("### 🇻🇳 Nghĩa tiếng Việt (chuẩn thương mại)")
...
if menu == "📈 Dashboard":
    ...
    st.markdown("### 📊 Gợi ý học")
    st.write("Nên học 10–15 từ mỗi ngày để đạt hiệu quả TOEIC tốt nhất.")
